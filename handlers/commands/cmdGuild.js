...
function getGuildToggleEmbed()
{
	...
	const fields = [
		...
		{name:"🧤 ||Black Hand||",value:"There is no such guild as the ||Black Hand||, at least officially, and it exists as little more than whispered rumors. A guild of stealth, subterfuge, and secrecy, the ||Black Hand|| operates in the shadows as part criminal syndicate, part espionage agency, under the watchful eye of the <@&701985965882867712> and the <@&833508689624563783>. Their domain are the slums and undercity - those places where people are beneath the notice of the reputable citizens."},
		{name:"🕯️ Faith Council",value:"The divine is everwhere in the multiverse, and the demiplane has drawn in followers of countless different faiths and gods. The council of faith honors the myriad deities and tends to their followers. The <@&766024439749148672> and their council of <@&782123983797616700>s maintain the temples, and keep the citizens of Ost in good health, making them one the guild closest to the common people."},
		{name:"⚔️ Guardians",value:"Ost in Edhil is largely a peaceful city, thanks in no small part to the efforts of the Guardian Guild. A guild of martial prowess, the Guardians serve as both city guard and military arm of Ost in Edhil, under the leadership of the <@&699575897853788302> and the <@&833505914619166721>. The Colosseum serves as their recruitment, testing, and training grounds, but they can be seen patrolling the streets of Ost, keeping it safe for the average citizen."},
