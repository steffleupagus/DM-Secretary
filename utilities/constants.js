...
const ERROR = {
	...
	USER_PARTICIPANTS: {name:"Participants", value: (err) => `Requires two or more players.`},
...
ERROR.KEY = Object.keys(ERROR).reduce((keys, key) => { return {...keys, [key]: key} }, {});
...
const THUMB = {
	DUEL:"https://i.imgur.com/2U90DwW.png",
	SCENE:"",
	TABLE:""
}
